...
const Web3Provider = dynamic(() => import("@/components/web3-provider").then((mod) => mod.Web3Provider), { ssr: false })
      ...
      <body className={inter.className}>
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem={false}>
          <Suspense fallback={<div className="h-16 border-b border-border/10"></div>}>
            {/* Envolver Web3Provider y EnhancedNavbar en un ClientOnly component */}
            <ClientOnly>
              <Web3Provider>
                <BackgroundWrapper>
